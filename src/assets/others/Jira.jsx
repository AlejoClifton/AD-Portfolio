const Jira = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={40} height={40} fill="none" viewBox="0 0 32 32" {...props}>
        <path
            fill="#2684FF"
        ...
        />
        <path fill="url(#a)" fillRule="evenodd" d="M16 11.86a6.81 6.81 0 0 1-.03-9.827l-9.366 9.055 5.097 4.93L16 11.861Z" clipRule="evenodd" />
        <path
            fill="url(#b)"
            fillRule="evenodd"
